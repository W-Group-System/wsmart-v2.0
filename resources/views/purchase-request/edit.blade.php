    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="box box-primary">
                <div class="box-body">
                    <form method="post" id="editPurchaseRequestForm">
                        @csrf
                            ...
                            <div class="col-lg-6">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="date" class="form-control input-sm" name="due_date" value="{{ $purchase_request->due_date }}" required>
                                    </div>
                                    <div class="col-lg-6">
                                        <label>Remarks</label>
                                        <textarea name="remarks" id="remarks" class="form-control input-sm" cols="30" rows="10" required>{{ $purchase_request->remarks }}</textarea>
                                    </div>
                                </div>

            ...
            <form method="post" id="updateUserForm">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            Department
                            <select data-placeholder="Select department" name="department" id="editDepartment" class="select2 form-control" style="width: 100%;" required>
                                <option value=""></option>
                        ...
                        <div class="col-md-12">
                            Subsidiary
                            <select data-placeholder="Select subsidiary" name="subsidiary" id="editSubsidiary" class="select2 form-control" style="width: 100%;" required>
                                <option value=""></option>
